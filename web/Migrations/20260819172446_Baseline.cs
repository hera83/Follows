        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThemePreference = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    PreferredLanguage = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false, defaultValue: "da"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextMutedColor = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ThemeSettings_Name_ThemeMode",
                table: "ThemeSettings",
                columns: new[] { "Name", "ThemeMode" },
                unique: true);
        }
